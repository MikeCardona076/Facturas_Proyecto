<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmProducto.aspx.cs" Inherits="Facturas_proyecto.View.frmProducto" %><!DOCTYPE html>
    ...
    <body>
         <form id="form1" runat="server">
            ...
            <div>
                ...
                <asp:TextBox ID="txbFechaCaducidad" runat="server"></asp:TextBox>
            </div>
            <div>
                <asp:Label ID="lbRFC" runat="server" Text="RFC"></asp:Label>
                <asp:TextBox ID="txbCodigoBarras" runat="server"></asp:TextBox>
            </div>
            <div>
                <asp:Label ID="lbEmail" runat="server" Text="Email"></asp:Label>
                <asp:TextBox ID="txbProveedorProd" runat="server"></asp:TextBox>
            </div>
            <div>
            ...
            <asp:GridView ID="GridProducto" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
